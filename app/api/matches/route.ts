  ...
  try {
    ...
    const match = await db.match.create({
      data: {
        ...
        svgPL1: data.svgPL1 || `https://flagcdn.com/w40/${data.nazionalitaPL1.substring(0, 2).toLowerCase()}.png`,
        etàPL1: data.etàPL1,
        ...
        svgPL2: data.svgPL2 || `https://flagcdn.com/w40/${data.nazionalitaPL2.substring(0, 2).toLowerCase()}.png`,
        etàPL2: data.etàPL2,
